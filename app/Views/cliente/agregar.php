<div class="container">
    <div class= "row">
        ...
        <form action="<?= base_url('index.php/cliente/insert'); ?>" method="POST" enctype="multipart/form-data"> 
            <?= csrf_field() ?>
                <div class="tipoConsulta"><label for="" class="form-label">Tipo de Consulta</label> <!-- Formulario para agregar --->
                ...
                <div class="mb-3"> <!-- llamado de datos de otro tabla atraves de un bucle PHP -->
